...
HD_PWD='D:/MyProgramme/Vivado/Sorting_Module/Sorting_Module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestInborad.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestInborad.tcl -notrace
