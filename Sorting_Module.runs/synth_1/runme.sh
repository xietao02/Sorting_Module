...
HD_PWD='D:/MyProgramme/Vivado/Sorting_Module/Sorting_Module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestInborad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestInborad.tcl
